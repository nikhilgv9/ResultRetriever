...
public class GroupResult<T> extends ArrayList{
    ...
    Map<String,Integer> failCount=new HashMap<String,Integer>();
    int totalPass=0;
    int totalFail=0;
    ...
    public boolean add(Object e) {
        if(e instanceof StudentResult)
        {
            ...
            for(ExamResult er:subResults)
            {
                ...
                {
                    Integer failcount=passCount.get(code);
                    if(failcount==null){
                        failcount=new Integer(0);
                    }
                    failcount++;
                    failCount.put(code, failcount);
                    failed=true;
                }
            }
            if(!failed){
    ...
    public void setFailCount(Map<String, Integer> failCount) {
